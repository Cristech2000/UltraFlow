...
function Sidebar({ isOpen, onToggle }) {
  ...
  return (
    <motion.aside
      ...
      className="flex flex-col bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 text-gray-900 dark:text-white relative flex-shrink-0 h-full overflow-hidden shadow-xl dark:shadow-none"
    >
      {/* Logo */}
      ...
      <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        {showTaskNav && (
          <>
            ...
            <p className={`text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider px-3 py-2 ${!isOpen && 'sr-only'}`}>
              Tasks
            </p>
            {taskNav.map((item) => {
